...
public interface Dialect {
    ...
    /**
     * Return a SQL statement used to obtain the numbers of rows for a given table
     * @return a statement used to query your RDBMS for the number of rows in a table
     */
