...
//        testSuccessResponse(r, Response.Status.OK, 1);
    ...
    public void testReadAllResources(){
        ...
        // test a view
        r = (AmforeasSuccess)controller.getAllResources("maker_stats_2010", new LimitParam(1000),  new OrderParam("month"));
...
//    @Test
    public void testFindByDynamicFinder(){
        ...
        AmforeasError err = (AmforeasError)controller.findByDynamicFinder("users","findAllByCreditLessThan", Arrays.asList(new String [] {"0"}), limit, order);
        testErrorResponse(err, Response.Status.NOT_FOUND, null, null);
        
        err = (AmforeasError)controller.findByDynamicFinder("users","findAllByCreditLessThhhhan", Arrays.asList(new String [] {"0"}), limit, order);
        testErrorResponse(err, Response.Status.BAD_REQUEST, null, null);
        
        err = (AmforeasError)controller.findByDynamicFinder("users","findAllByCreditLessThhhhan", Arrays.asList(new String [] {""}), limit, order);
        testErrorResponse(err, Response.Status.BAD_REQUEST, null, null);
        
        err = (AmforeasError)controller.findByDynamicFinder("users","", Arrays.asList(new String [] {"0"}), limit, order);
        testErrorResponse(err, Response.Status.BAD_REQUEST, null, null);
        
        err = (AmforeasError)controller.findByDynamicFinder("users", null, Arrays.asList(new String [] {"0"}), limit, order);
        testErrorResponse(err, Response.Status.BAD_REQUEST, null, null);
        ...
        err = (AmforeasError)controller.findByDynamicFinder(null,null, Arrays.asList(new String [] {"0"}), limit, order);
        testErrorResponse(err, Response.Status.BAD_REQUEST, null, null);
        
        err = (AmforeasError)controller.findByDynamicFinder("users","findAllByCreditLessThan", new ArrayList<String>(), limit, order);
    ...
    public void testFindResources(){
        ...
        r = (AmforeasSuccess)controller.findResources("maker_stats_2010","maker","FIAT", limit, new OrderParam("month"));
    ...
    private void testErrorResponse(AmforeasError err, Response.Status expectedStatus, String expectedSqlState, Integer expectedSqlCode){
    ...
    private void testDynamicFinder(String resource, String finder, int expectedResults, String...  arr){
        AmforeasSuccess r = (AmforeasSuccess)controller.findByDynamicFinder(resource,finder, Arrays.asList(arr), limit, order);
